...
d3 = load('fittedCurve_3degree_QR.dat','ascii');
d5 = load('fittedCurve_5degree_QR.dat','ascii');
...
title(sprintf('QR Factorization Method: Polynomial Fitting Least Squares Problem'), 'Fontsize', 16, 'Interpreter', 'latex')
